...
# Contributing to A Distributive Project
...
> [Documentation](https://docs.dcp.dev).
...
- Determine if your bug is really a bug and not an error on your side e.g. using
  ...
  [documentation](https://docs.dcp.dev). If you are looking for support, you
...
This section guides you through submitting an enhancement suggestion for A
Distributive Project, **including completely new features and minor improvements
...
- Make sure that you are using the latest version.
- Read the [documentation](https://docs.dcp.dev) carefully and find out if the
...
- **Explain why this enhancement would be useful** to most A Distributive
  Project users. You may also want to point out the other projects that solved
